...
def load_data(path):
    """C:/Users/GARAO/Downloads/Sample - Superstore (1).xlsx"""
    return pd.read_excel("C:/Users/GARAO/Downloads/Sample - Superstore (1).xlsx")
...
def main():
    data_path = 'C:/Users/GARAO/Downloads/Sample - Superstore (1).xlsx'  # Update path if needed
